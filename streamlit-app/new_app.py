        ...
        with st.spinner('Generating awesome slides for you...⏳'):
            ...
            try:
                ...
                gpt_comp_response = generate_gpt_response(gpt_input=input_competitors, max_tokens=250,
                                                          api_key=openai_key, llm_model=llm_model)
                ...
                # return response from GPT-3
                gpt_swot = generate_gpt_response(gpt_input=input_swot, max_tokens=1000, api_key=openai_key,
                                                 llm_model=llm_model)
                ...
                # return response from GPT-3
                gpt_value_prop = generate_gpt_response(gpt_input=input_vp, max_tokens=1000, api_key=openai_key,
                                                       llm_model=llm_model)
